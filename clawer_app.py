...
for page in range(0, 1):
    ...
    df_product.to_csv('product_data0322.csv', index=False)  #要寫入excel才開啟!!!!!!!!!
...
def main():
    df = pd.read_csv('product_data0322.csv')
...
if __name__ == "__main__":
    ...
    st.write("Welcome to the Product Data Visualization App!")
    st.write("This app displays visualizations for the product data scraped from the Carrefour website.")
    main()
